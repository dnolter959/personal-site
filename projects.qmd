...
It turns out people don't like completing surveys, especially longitudinal ones. What are you supposed to do with the half-data you are left with at the end? [This R package](https://github.com/dnolter959/longdrop2) implements a statistical method proposed by Moreno-Betancur and Chavance in their 2013 paper, which facilitates sensitivity analyses of Mixed Model results to various departures from the Missing at Random (MAR) assumption, in the presence of drop-out.
